...
jQuery.extend(jQuery.validator.messages, {
	...
	rangeValue: "Por favor, forne&ccedil;a um valor entre {0} e {1}.",

	range: "Por favor, forne&ccedil;a um valor entre {0} e {1}.",

	maxValue: "Por favor, forne&ccedil;a um valor menor que ou igual a {0}.",

	max: "Por favor, forne&ccedil;a um valor menor ou igual a {0}.",

	minValue: "Por favor, forne&ccedil;a um valor maior ou igual a {0}.",
